...
* Issue where map becomes black/doesn't load new chunks after a certain time (~60 minutes) issue #25 on github thanks to @DARKACE for the fix
...
* Fix Arithmetic Overflow Crash issue #24 on github thanks to @DARKACE for the report
