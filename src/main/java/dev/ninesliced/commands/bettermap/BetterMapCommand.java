...
public class BetterMapCommand extends AbstractCommand {
    ...
    public BetterMapCommand() {
        ...
        this.addSubCommand(new PlayerHideGlobalWaypointsCommand());
        this.addSubCommand(new PlayerHidePersonalWaypointsCommand());
    ...
    protected CompletableFuture<Void> execute(@Nonnull CommandContext context) {
        ...
        if (canAccessConfig) {
            ...
            context.sendMessage(Message.raw("Hide Global Waypoints: ").color(Color.YELLOW).insert(Message.raw(config.isHideGlobalWaypointsOnMap() ? "Enabled" : "Disabled").color(Color.WHITE)));
